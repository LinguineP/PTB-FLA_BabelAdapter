...
public class MessagingHandler implements SignalHandler {
	...
	private static final Logger logger = LogManager.getLogger(MessagingHandler.class);
	...
	public MessagingHandler(String[] args) throws IOException, InvalidParameterException, HandlerRegistrationException {
		...
		System.out.println("Creating an new Messaging handler");
	...
	public UserMessageListener getListener() {
		return listener;
	}
	...
	public void setMembershipListener(MembershipMonitor mcl) {
		this.mm=mcl;
	}
	...
	public DataDisseminationApp getApp() {
		return app;
	}

	public void setApp(DataDisseminationApp app) {
		this.app = app;
	}

	public void setListener(UserMessageListener listener) {
		this.listener = listener;
	}

	public HyParView getHyparview() {
		return hyparview;
	}

	public void setHyparview(HyParView hyparview) {
		this.hyparview = hyparview;
	}

	public MembershipMonitor getMm() {
		return mm;
	}

	public void setMm(MembershipMonitor mm) {
		this.mm = mm;
	}

	public EagerPushGossipBroadcast getBcast() {
		return bcast;
	}

	public void setBcast(EagerPushGossipBroadcast bcast) {
		this.bcast = bcast;
	}

	public AntiEntropy getAt() {
		return at;
	}

	public void setAt(AntiEntropy at) {
		this.at = at;
	}

	public RandomTour getRandomTour() {
		return randomTour;
	}

	public void setRandomTour(RandomTour randomTour) {
